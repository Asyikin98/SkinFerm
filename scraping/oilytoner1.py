...
def crawl_url(pageUrl, toner_arr):
    url = 'https://www.skinstore.com/skin-care/skincare-concern/oily-skin.list?pageNumber=1&facetFilters=averageReviewScore_auto_content:%5B4+TO+5%5D|en_brand_content:ARCONA|en_brand_content:Caudalie|en_brand_content:Obagi|en_brand_content:Perricone+MD|en_brand_content:SkinCeuticals|en_skincareproducttype_content:Toner|en_brand_content:Jurlique'
    page = get(url)
