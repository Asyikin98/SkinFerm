...
def crawl_url(pageUrl, mask_arr):
    url = 'https://www.skinstore.com/skin-care/skincare-concern/oily-skin.list?pageNumber=1&facetFilters=averageReviewScore_auto_content:%5B4+TO+5%5D|en_brand_content:Avene|en_brand_content:TONYMOLY|en_skincareproducttype_content:Mask|en_brand_content:REN+Clean+Skincare'
    page = get(url)
