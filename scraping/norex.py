...
def crawl_url(pageUrl, exnor_arr):
    url = 'https://www.ry.com.au/skin-care/normal-combination-skin.list?pageNumber=1&facetFilters=en_skincareproducttype_content:Exfoliator|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
