...
def crawl_url(pageUrl, cleanserdry_arr):
    url = 'https://www.skinstore.com/skin-care/cleansers.list?pageNumber=1&facetFilters=en_brand_content:Avene|en_brand_content:La+Roche-Posay|averageReviewScore_auto_content:%5B4+TO+5%5D|en_skincareproducttype_content:Cleanser|en_skinconcern_content:Dry'
    page = get(url)
