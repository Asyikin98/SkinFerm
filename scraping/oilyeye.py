...
def crawl_url(pageUrl, eye_arr):
    url = 'https://www.ry.com.au/skin-care/oily-skin.list?pageNumber=1&facetFilters=en_skincareproducttype_content:Eye+Care|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
