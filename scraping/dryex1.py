...
def crawl_url(pageUrl, exdry_arr):
    url = 'https://www.skinstore.com/skin-care/skincare-concern/dry-skin.list?pageNumber=1&facetFilters=en_skincareproducttype_content:Exfoliator|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
