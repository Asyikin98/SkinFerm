...
def crawl_url(pageUrl, tonernor_arr):
    url = 'https://www.ry.com.au/skin-care/normal-combination-skin.list?pageNumber=1&facetFilters=averageReviewScore_auto_content:%5B4+TO+5%5D|en_skincareproducttype_content:Toner'
    page = get(url)
