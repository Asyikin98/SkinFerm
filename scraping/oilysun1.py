...
def crawl_url(pageUrl, sun_arr):
    url = 'https://www.skinstore.com/skin-care/sunscreen.list?pageNumber=1&facetFilters=en_skinconcern_content:Oily+%26+Shiny+Skin|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
