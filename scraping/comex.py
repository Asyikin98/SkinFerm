...
def crawl_url(pageUrl, excom_arr):
    url = 'https://www.ry.com.au/skin-care/exfoliator.list?pageNumber=1&facetFilters=en_skinconcern_content:Combination+Skin|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
