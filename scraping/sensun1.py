...
def crawl_url(pageUrl, sunsen_arr):
    url = 'https://www.skinstore.com/skin-care/sunscreen.list?pageNumber=1&facetFilters=en_brand_content:La+Roche-Posay|en_brand_content:Obagi|en_brand_content:PCA+SKIN|en_brand_content:Peter+Thomas+Roth|en_skinconcern_content:Sensitive|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
