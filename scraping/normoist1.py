...
def crawl_url(pageUrl, moistnor_arr):
    url = 'https://www.skinstore.com/skin-care/skincare-concern/normal-combination.list?pageNumber=1&facetFilters=averageReviewScore_auto_content:%5B4+TO+5%5D|en_brand_content:Caudalie|en_brand_content:Dr.+Brandt|en_brand_content:Elemis|en_brand_content:Epionce|en_brand_content:ESPA|en_skincareproducttype_content:Moisturizer|en_brand_content:Gallin%C3%A9e'
    page = get(url)
