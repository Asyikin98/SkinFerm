...
def crawl_url(pageUrl, tonersen_arr):
    url = 'https://www.ry.com.au/skin-care/sensitive-skin.list?pageNumber=1&facetFilters=en_brand_content:Dermalogica|en_brand_content:Dr.+Hauschka|en_brand_content:ESPA|en_brand_content:Gatineau|en_brand_content:MONU|en_brand_content:Pai|en_brand_content:Thalgo|en_skincareproducttype_content:Toner'
    page = get(url)
