...
def crawl_url(pageUrl, moistcom_arr):
    url = 'https://www.skinstore.com/skin-care/moisturizers.list?pageNumber=1&facetFilters=en_skinconcern_content:Combination|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
