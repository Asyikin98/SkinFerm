...
def crawl_url(pageUrl, cleansersen_arr):
    url = 'https://www.ry.com.au/skin-care/sensitive-skin.list?pageNumber=1&facetFilters=en_skincareproducttype_content:Cleanser|averageReviewScore_auto_content:%5B4+TO+5%5D'
    page = get(url)
