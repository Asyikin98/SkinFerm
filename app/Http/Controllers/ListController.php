        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Edit Users Profile </h3>
            </div>
            <hr>
                ...
                if(isset($_POST['edit_btn']))
                {
                    ...
                    foreach($query_run as $row)
                    {
                        ?>
                          ...
                          <form action="{{action('UpdateController@update')}}" method="POST">
                              ...
                              <a href="http://localhost/fyp/fyp/public/adminuser" class="btn btn-danger" > CANCEL  </a>
