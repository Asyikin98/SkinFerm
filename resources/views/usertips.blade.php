        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="http://localhost/fyp/fyp/public/dryroutine"> Morning </a></li>
                  <li class="nav-item"> <a class="nav-link" href="http://localhost/fyp/fyp/public/dryroutinen"> Night </a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="http://localhost/fyp/fyp/public/usertips" aria-expanded="false" aria-controls="general-pages">
          ...
          <div class="content-wrapper">
            ...
            <hr>
                      ...
                      <tbody>
                            ...
                            ?>
                            <?php
                            $res=mysqli_query($conn,"select * from tips");
