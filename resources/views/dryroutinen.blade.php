      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/fyp/fyp/public/usertips">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Dry Skincare Routine: <b> NIGHT </b>  </h3>
            </div>
            <hr>
                      ...
                      <tbody>
                            ...
                            ?>
                            <?php
                            $res=mysqli_query($conn,"select * from dryroutinen");
