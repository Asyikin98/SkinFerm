      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/fyp/fyp/public/comskincareCategory">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Moisturizer for Combination Skin </h3>
            </div>
              <hr>
              ...
              <tbody>
                    ...
                    ?>
                    <?php
                    $res=mysqli_query($conn,"select * from commoistd");
                    while ($row=mysqli_fetch_array($res)) {
                      ?>
                              ...
                              <a href="http://localhost/fyp/fyp/public/commoist">Back</a>
