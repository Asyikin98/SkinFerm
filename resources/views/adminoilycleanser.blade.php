...
<html lang="en">
  <head>
    ...
    <title>Cleanser Oily Skin</title>
    <!-- plugins:css -->
             ...
             <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
               ...
               <tbody>
                 ...
                 while ($row=mysqli_fetch_array($res))
                 {
                   ?>
                       <tr>
                         <td><img src="<?php echo $row["image"]; ?>" alt="" width="200" height="130" style="float: left; margin-right: 10px; margin-bottom: 5px;"/></td>
                         <td><p><b><?php echo $row["name"]; ?></b></p></td>
                         <td><p><?php echo $row["price"]; ?></p></td>
                         <td><p><?php echo $row["rating"]; ?></p></td>
                         <td>
                           <form action="{{URL::to('/list')}}" method="post">
