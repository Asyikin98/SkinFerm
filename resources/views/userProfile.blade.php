...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../resources/sass/userProfile.css" type="text/css">
          ...
          <div class="content-wrapper">
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                  <label> Name </label>
                  <input type="text" name="edit_name" class="form-control" placeholder="Full Name">
                </div>
                <div class="form-group">
                  <label> Email </label>
                  <input type="text" name="edit_email" class="form-control" placeholder="Email">
                </div>
                <div class="form-group">
                  <label> Password </label>
                  <input type="text" name="edit_password" class="form-control" placeholder="Password">
                </div>
